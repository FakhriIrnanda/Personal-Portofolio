      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @if ($github)
                <a class="btn btn-outline-light btn-social mx-1" href="{{$github}}" target="blank">
                    <i class="fab fa-fw fa-github"></i></a>  
            @endif

            @if ($instagram)
                <a class="btn btn-outline-light btn-social mx-1" href="{{$instagram}}" target="blank">
                    <i class="fab fa-fw fa-instagram"></i></a>
            @endif

            @if ($twitter)
                <a class="btn btn-outline-light btn-social mx-1" href="{{$twitter}}" target="blank">
                    <i class="fab fa-fw fa-twitter"></i></a>
            @endif

            @if ($facebook)
                <a class="btn btn-outline-light btn-social mx-1" href="{{$facebook}}" target="blank">
